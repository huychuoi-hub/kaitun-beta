...
LMG2L["Frame_2"]["BackgroundColor3"] = Color3.fromRGB(243, 222, 255)
LMG2L["Frame_2"]["Size"] = UDim2.new(0, 380, 0, 224)
LMG2L["Frame_2"]["Position"] = UDim2.new(0, 174, 0, 4)
LMG2L["Frame_2"]["BackgroundTransparency"] = 0.49
LMG2L["UICorner_3"] = Instance.new("UICorner", LMG2L["Frame_2"])
LMG2L["UIStroke_8"] = Instance.new("UIStroke", LMG2L["Frame_2"])
LMG2L["UIStroke_8"]["Thickness"] = 2

-- Hiển thị LEVEL (Tự động cập nhật)
LMG2L["TextLabel_4"] = Instance.new("TextLabel", LMG2L["Frame_2"])
LMG2L["TextLabel_4"]["TextSize"] = 10
LMG2L["TextLabel_4"]["BackgroundColor3"] = Color3.fromRGB(243, 222, 255)
LMG2L["TextLabel_4"]["TextColor3"] = Color3.fromRGB(35, 0, 0)
LMG2L["TextLabel_4"]["BackgroundTransparency"] = 1
LMG2L["TextLabel_4"]["Size"] = UDim2.new(0, 76, 0, 34)
LMG2L["TextLabel_4"]["Position"] = UDim2.new(0, 8, 0, 2)
LMG2L["UIStroke_5"] = Instance.new("UIStroke", LMG2L["TextLabel_4"])

-- Hiển thị TÊN (Lấy tên người chơi thật)
...
LMG2L["TextLabel_6"]["Size"] = UDim2.new(0, 108, 0, 34)
LMG2L["TextLabel_6"]["Position"] = UDim2.new(0, 270, 0, 2)
LMG2L["TextLabel_6"]["Text"] = "Name: " .. Player.Name

-- Hiển thị Tên Hub (chuoirayhub kaitun)
...
LMG2L["TextLabel_7"]["Size"] = UDim2.new(0, 108, 0, 54)
LMG2L["TextLabel_7"]["Text"] = "chuoirayhub kaitun"
LMG2L["TextLabel_7"]["Position"] = UDim2.new(0, -120, 0, 72)

-- Hiển thị Trạng thái (Beta/Thông báo)
LMG2L["TextLabel_9"] = Instance.new("TextLabel", LMG2L["Frame_2"])
LMG2L["TextLabel_9"]["TextSize"] = 15
LMG2L["TextLabel_9"]["BackgroundTransparency"] = 1
LMG2L["TextLabel_9"]["Size"] = UDim2.new(0, 380, 0, 52)
LMG2L["TextLabel_9"]["Position"] = UDim2.new(0, 0, 0, 120)
LMG2L["UIStroke_a"] = Instance.new("UIStroke", LMG2L["TextLabel_9"])

--- LOGIC XỬ LÝ ĐỢI VÀ CHẠY SCRIPT ---
...
task.spawn(function()
    ...
    task.spawn(function()
        while true do
            ...
            LMG2L["TextLabel_4"]["Text"] = "LEVEL: " .. tostring(lv)
            task.wait(1)
        end
    end)

    -- Đợi 5 giây đầu: Thông báo lỗi Beta
    LMG2L["TextLabel_9"]["Text"] = "script đang ở beta nên hơi lỗi thông cảm"
    task.wait(5)

    -- Đợi 2 giây tiếp theo: Chuẩn bị
    LMG2L["TextLabel_9"]["Text"] = "Đang chuẩn bị Auto Level..."
    task.wait(2)

    -- Sau 7 giây: Bắt đầu chạy Code Farm
    LMG2L["TextLabel_9"]["Text"] = "Status: Done"
    
    -------------------------------------------------------
    -- DÁN CODE AUTOLEVEL CỦA BẠN VÀO DƯỚI ĐÂY --
    -------------------------------------------------------
    print("Kích hoạt thành công ChuoirayHub kaitun!")
